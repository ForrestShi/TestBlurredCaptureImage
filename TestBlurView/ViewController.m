...
- (IBAction)onPressMe:(id)sender{
    UIImage *capturedImage = [self rn_screenshot];
    UIImage *blurredImage = [capturedImage rn_boxblurImageWithBlur:1. exclusionPath:[UIBezierPath bezierPathWithOvalInRect:self.view.bounds]];
    //self.resultImgView.image = blurredImage;
    [self.view addSubview:[[UIImageView alloc] initWithImage:blurredImage]];
}
